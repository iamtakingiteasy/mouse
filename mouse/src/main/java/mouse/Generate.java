...
//    150724 Generate call to 'closeParser' instead of 'failure'.
//
//=========================================================================
  ...
  void generate()
    {
      ...
      out.BOX("This file was generated by Mouse 1.9 at " +
  ...
  void genSkel()
    {
      ...
      //  Create header.
      //---------------------------------------------------------------
      out.BOX("This skeleton was generated by Mouse 1.9 at " + date + " GMT\n" +
               "from grammar '" + gramPath + "'.");
      out.line("");
